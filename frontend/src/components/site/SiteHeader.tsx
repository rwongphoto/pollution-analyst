...
const NAV: { key: Active; href: string; label: string }[] = [
  ...
  { key: "county", href: "/state/ca/county/kern", label: "Counties" },
  { key: "city", href: "/state/ca/city/stockton", label: "Cities" },
  { key: "facility", href: "/state/ca/facility/chevron-products-co-richmond-refinery", label: "Facilities" },
