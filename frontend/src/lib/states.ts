...
export const LIVE_STATES: LiveState[] = [
  ...
  { slug: "ia", abbr: "IA", name: "Iowa", region: "Midwest" },
  { slug: "id", abbr: "ID", name: "Idaho", region: "Rocky Mountain" },
  { slug: "il", abbr: "IL", name: "Illinois", region: "Midwest" },
  { slug: "in", abbr: "IN", name: "Indiana", region: "Midwest" },
  { slug: "ks", abbr: "KS", name: "Kansas", region: "Midwest" },
  ...
  { slug: "mi", abbr: "MI", name: "Michigan", region: "Midwest" },
  { slug: "mn", abbr: "MN", name: "Minnesota", region: "Midwest" },
  { slug: "mo", abbr: "MO", name: "Missouri", region: "Midwest" },
  ...
  { slug: "oh", abbr: "OH", name: "Ohio", region: "Midwest" },
  ...
  { slug: "sc", abbr: "SC", name: "South Carolina", region: "South" },
  { slug: "sd", abbr: "SD", name: "South Dakota", region: "Rocky Mountain" },
  { slug: "tn", abbr: "TN", name: "Tennessee", region: "South" },
  ...
  { slug: "wi", abbr: "WI", name: "Wisconsin", region: "Midwest" },
