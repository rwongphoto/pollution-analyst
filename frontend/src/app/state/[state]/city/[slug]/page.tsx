  ...
  return (
    <>
      ...
      <main>
        ...
        <NotableSignals
          flags={data.flags ?? []}
          emptyLabel={`No notable signals at the city level this reporting year. Pathway summary, top facilities${data.water.utilities_count > 0 ? ", and water systems" : ""} below.`}
        />
